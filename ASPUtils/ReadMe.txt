========================================================================
    ACTIVE TEMPLATE LIBRARY : ASPUtils Project Overview
========================================================================

AppWizard has created this ASPUtils project for you to use as the starting point for
...
ASPUtils.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ASPUtils.h)
        GUID definitions                                (ASPUtils_i.c)
        A type library                                  (ASPUtils.tlb)
        Marshaling code                                 (ASPUtils_p.c and dlldata.c)

ASPUtils.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ASPUtils.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ASPUtils.pch and a precompiled types file named StdAfx.obj.
...
ASPUtilsps.vcxproj
	...
	dlldata.c, ASPUtils_i.c and ASPUtils_p.c which are required
	to build the proxy/stub DLL.

ASPUtilsps.vcxproj.filters
